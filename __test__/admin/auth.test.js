...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Rubie43',
      password: 'qjJI8mrw8vAQTKW',
      email: 'Micaela41@gmail.com',
      name: 'Vanessa Jenkins',
      userType: 197,
      mobileNo: '422.701.7542 x185',
      resetPasswordLink: {},
      loginRetryLimit: 878,
      loginReactiveTime: '2022-06-01T17:59:29.340Z',
      id: '624177d209f7f200b5d599b1'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Cayla_McClure',
        'password':'W2UVXHNisBQuJPf',
        'email':'Jonas0@yahoo.com',
        'name':'Garry Bruen Jr.',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'559-972-2020 x03344',
