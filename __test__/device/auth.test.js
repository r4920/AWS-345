...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Mathias0',
      password: 'rlkVmzUEZ1apjG2',
      email: 'Leo_Jacobson@hotmail.com',
      name: 'Blanche Donnelly',
      userType: 527,
      mobileNo: '437.341.0554',
      resetPasswordLink: {},
      loginRetryLimit: 754,
      loginReactiveTime: '2022-06-25T19:59:24.527Z',
      id: '624177d209f7f200b5d59a32'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Anya_Yundt81',
        'password':'Pbvv_gMMSskdanX',
        'email':'Dudley46@hotmail.com',
        'name':'Kristin Labadie',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(292) 739-1860 x6149',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Dudley46@hotmail.com', });
